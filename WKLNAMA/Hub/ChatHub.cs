...
//            }
//        }
//        public async Task PushNotifications(long toUserId) 
//        {
//            using (var scope = _serviceProvider.CreateScope())
//            {
//                _notificationService = scope.ServiceProvider.GetRequiredService<INotificationRepository>();

//                var unReadNotification = await _notificationService.GetAllUnReadNotification(toUserId);

//                await UnReadNotification(unReadNotification, unReadNotification.Count(), toUserId.ToString());
