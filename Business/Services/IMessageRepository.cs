...
namespace Business.Services
{
    public interface IMessageRepository : IBaseRepository<Message>
    {
        ...
        public Task CreateChatSession(MessageVm message);
